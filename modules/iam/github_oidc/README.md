...
|------|-------------|------|---------|:--------:|
| <a name="input_attach_admin_policy"></a> [attach\_admin\_policy](#input\_attach\_admin\_policy) | Quick start: attach admin while bootstrapping; we’ll tighten later | `bool` | `true` | no |
